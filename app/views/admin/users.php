    ...
    <div class="col-xl-5">
      <div class="gh-card p-4 mb-3">
        ...
        <form method="post" class="d-grid gap-2" action="<?= e(url('admin/users.php')) ?>">
          ...
          <select class="form-select" name="role" required><option value="">Role...</option><option value="resident">Resident</option><option value="guard">Guard</option><option value="admin">Admin</option></select>
          <input class="form-control" name="house_number" placeholder="House number (resident)">
          <input class="form-control" name="block_number" placeholder="Block number (resident)">
          <input class="form-control" name="contact_number" placeholder="Contact number">
          <input class="form-control" name="guard_code" placeholder="Guard code (guard)">
          <input class="form-control" name="shift_name" placeholder="Shift name (guard)">
          <input class="form-control" name="admin_code" placeholder="Admin code (admin)">
